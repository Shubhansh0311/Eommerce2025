...
export default function Navigation() {
  ...
  return (
    <div className="bg-white ">
      {/* Mobile menu */}
      <Dialog open={open} onClose={handleClose} className="relative z-40 lg:hidden">
        <DialogBackdrop
          transition
                        ...
                        >
                          {section.items.map((item) => (
                            <li key={item.name} className="flow-root">
                              <a href={item.href} className="-m-2 block p-2 text-gray-500" onClick={() => handleCategoryClick(category, section, item)}>
                                {item.name}
                              </a>
                            </li>
                          ))}
