                        ...
                        <div className="grid grid-cols-1 gap-x-8  lg:grid-cols-5">
                            ...
                            <form className="hidden lg:block border-2 border-gray-100 px-2">
                                <div className="flex justify-between items-center pb-6 pt-2">
                                    <h2 className='font-semibold opacity-50 pl-2 text-gray-600 '>Filters</h2>
                                    <FilterListIcon />
                                </div>
                                {Multiplefilters.map((section) => (
                                    <Disclosure key={section.id} as="div" className="border-b border-gray-100 pt-3">
                                        <h3 className="-my-3 flow-root">
                                            <DisclosureButton className="group flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                                                {/* <span className="font-medium text-gray-900">{section.name}</span> */}
                                                <FormLabel id="demo-radio-buttons-group-label" sx={{ fontSize: '14px', margin: '0px 10px ' }}>{section.name}</FormLabel>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    >
                                                        ...
                                                        {section.options.map((option, optionIdx) => (
                                                            ...
                                                            <FormControlLabel value={option.value} onChange={(e) => radioHandleChng(e, section.id)} control={<Radio />} label={option.label} />
                            ...
                            <div className="lg:col-span-4 border-2 border-gray-100  w-full ">
                                <div className=" flex flex-wrap gap-6 justify-center bg-white">
                                    {
                                        mens.map((product) => <ProductCard product={product} />)}
                                </div>
